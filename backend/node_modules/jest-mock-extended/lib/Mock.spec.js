...
(0, globals_1.describe)('jest-mock-extended', () => {
    ...
    (0, globals_1.test)('Can specify args', () => {
        ...
        (0, globals_1.expect)(mockObj.getSomethingWithArgs).toHaveBeenCalledWith(1, 2);
    });
    ...
    (0, globals_1.test)('Can specify fallbackMockImplementation', () => {
        ...
        (0, globals_1.expect)(() => mockObj.getSomethingWithArgs(1, 2)).toThrow('not mocked');
    });
    ...
    (0, globals_1.describe)('calledWith', () => {
        ...
        (0, globals_1.test)('can match object literals by value', () => {
            const mockFunc = (0, CalledWithFn_1.default)();
            mockFunc.calledWith({ id: 1, nested: { value: 'a' } }).mockReturnValue(3);
            (0, globals_1.expect)(mockFunc({ id: 1, nested: { value: 'a' } })).toBe(3);
            (0, globals_1.expect)(mockFunc({ id: 1, nested: { value: 'b' } })).toBe(undefined);
        });
    ...
    (0, globals_1.describe)('Deep mock support', () => {
        ...
        (0, globals_1.test)('fallback mock implementation can be overridden', () => {
            ...
            (0, globals_1.expect)(() => mockObj.getNumber()).toThrow('not mocked');
            (0, globals_1.expect)(() => mockObj.deepProp.getAnotherString('foo')).toThrow('not mocked');
        });
        (0, globals_1.test)('fallback mock implementation can be overridden while also providing a mock implementation', () => {
            ...
            (0, globals_1.expect)(() => mockObj.deepProp.getNumber(1)).toThrow('not mocked');
            (0, globals_1.expect)(() => mockObj.deepProp.getAnotherString('!')).toThrow('not mocked');
        });
    });
    ...
    (0, globals_1.describe)('overload support - #140', () => {
        (0, globals_1.test)('flat mock', () => {
            const mockObj = (0, Mock_1.default)();
            mockObj.header.mockImplementationOnce((headerName) => 'String');
        });
        (0, globals_1.test)('deep mock', () => {
            const mockObj = (0, Mock_1.mockDeep)();
            mockObj.header.mockImplementationOnce((headerName) => 'String');
        });
    });
