...
export default function Page() {
  return (
    <main style={{ background: COLORS.paper, color: COLORS.ink, paddingBottom: 60 }}>
      <BitterFontLinks />
      <SeoPageHeader />
      <Breadcrumb items={[{ name: 'Home', url: '/' }, { name: 'TNTET', url: '/tntet' }, { name: 'Paper 1', url: '/tntet/paper-1' }]} />
      <section style={{ maxWidth: 720, margin: '0 auto', padding: '20px 20px 30px' }}>
        <h1 style={{ fontFamily: FONT_FAMILY, fontSize: 30, fontWeight: 700, margin: '0 0 10px', lineHeight: 1.2 }}>
          TNTET Paper 1 — Classes 1 to 5 (Primary Level)
        </h1>
        <p style={{ fontSize: 15.5, color: COLORS.inkMuted, lineHeight: 1.75, marginBottom: 16 }}>
          TNTET Paper 1, Primary level (Classes 1-5) ஆசிரியர் பணிகளுக்கான தகுதி தேர்வு. 150 objective-type questions, 150 marks, 3 மணி நேரம், negative marking
          கிடையாது. பொது தகுதி மதிப்பெண் 60%.
        </p>
        ...
        <div style={{ display: 'flex', gap: 10, flexWrap: 'wrap', fontSize: 13.5 }}>
          <a href="/tntet/paper-2" style={{ color: COLORS.gold, textDecoration: 'underline' }}>TNTET Paper 2 →</a>
